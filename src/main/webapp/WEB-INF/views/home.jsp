			...
			<div class="row carousel-holder">
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="<c:url value="/resources/images/banner1.jpg"/>"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="<c:url value="/resources/images/banner2.jpg"/>"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="<c:url value="/resources/images/banner3.jpg"/>"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="<c:url value="/resources/images/banner4.jpg"/>"
									alt="">
							</div>
						</div>
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            <img ng-src="<c:url value="/resources/images/{{product.code}}.jpg"/>" alt="{{product.name}}" class="landingImg">
                            <h5>{{product.name}}</h5>
                            <hr/>
                            <div class="caption">
